#!/usr/bin/env python3
"""把 claude-notify 的 8 条 hook 写入 ~/.claude/settings.json。

构成：
  事件型 7 条：Notification / Stop / StopFailure / SubagentStop / SessionStart / SessionEnd / UserPromptSubmit
...
EVENTS_NORMAL = ["Notification", "Stop", "StopFailure", "SubagentStop", "SessionStart", "SessionEnd", "UserPromptSubmit"]
